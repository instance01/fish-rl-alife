...
print('ATTENTION! YOURE USING THE DEC 14 PICKLES!')
print('ATTENTION! YOURE USING THE DEC 14 PICKLES!')
print('ATTENTION! YOURE USING THE DEC 14 PICKLES!')
...
with open(base_path + 'i10_p150.pickle', 'rb') as f:
    i10_p150 = pickle.load(f)
with open(base_path + 'i10_p75.pickle', 'rb') as f:
    i10_p75 = pickle.load(f)
with open(base_path + 'i5_p150.pickle', 'rb') as f:
    i5_p150 = pickle.load(f)
with open(base_path + 'i5_p75.pickle', 'rb') as f:
